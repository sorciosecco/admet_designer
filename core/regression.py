...
def run_model_training():
    ...
    if settings.NPARA==False: ##### ALGORITHMS WITH DEFAULT PARAMETERS
        ...
        elif settings.MODEL=="ETR": model=ExtraTreesRegressor(n_estimators=parameters.n_estimators, criterion=parameters.criterion, max_features=parameters.max_features, max_depth=parameters.max_depth)
