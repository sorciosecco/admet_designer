...
def run_model_training():
    ...
    if settings.NPARA==False: ##### ALGORITHMS WITH DEFAULT PARAMETERS
        ...
        elif settings.MODEL=="RF": model=RandomForestRegressor(random_state=settings.SEED, n_jobs=None, criterion=parameters.criterion_rf, max_features=parameters.max_features, max_depth=parameters.max_depth, n_estimators=parameters.n_estimators)
        else: print("\nERROR: algorithm not supported\n")
